      ...
      >
        ...
        >
          ...
          <div class="flex-1">
            ...
            <div id="definitions" class="mb-12">
              ...
              <ul>
                ...
                <li>
                  <p>
                    ...
                    Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                    &quot;Our&quot; in this Agreement) refers to My Intellectual
                    Space.
                  </p>
                </li>
                <li>
                ...
                <li>
                  <p>
                    <strong>Website</strong> refers to My Intellectual Space,
                    accessible from
                    <a
                      href="https://myintellectualspace.com/"
                      rel="external nofollow noopener"
                      target="_blank"
                      >https://myintellectualspace.com/</a
                    >
                  </p>
                </li>
                <li>
            ...
            <div id="third-party" class="mb-12">
            ...
            <div id="contact" class="mb-12">
              ...
              <ul>
                <li>By email: privacy@myintellectualspace.com</li>
              </ul>
            </div>
          </div>
        </div>
...
h3 {
  @apply text-2xl font-bold leading-loose text-gray-900 dark:text-white mb-4;
}
h4 {
  @apply text-xl font-bold leading-loose text-gray-900 dark:text-white  mb-4;
}
h5 {
  @apply text-lg font-bold leading-loose text-gray-900 dark:text-white  mb-4;
}
ul {
  @apply ml-4 space-y-1 list-disc list-inside text-gray-700 dark:text-gray-300;
}
li {
  @apply leading-loose;
}
