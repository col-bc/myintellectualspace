    ...
    <div class="max-w-screen-xl mx-auto">
      ...
      >
        ...
        <p class="leading-loose mb-12">
          ...
          graphics, photos, audio, videos, or other materials or arrangements of
        ...
        <div id="who-may-use" class="mb-12">
          ...
          <p class="leading-loose mb-4">
            ...
            contract with My Intellectual Space and are not a person barred from
            receiving services under the laws of the applicable jurisdiction. In
            any case, you must be at least 13 years old to use the Services. If
            you are accepting these Terms and using the Services on behalf of a
        ...
        <div id="privacy" class="mb-12">
          ...
          <p class="leading-loose mb-4">
            ...
            countries for storage, processing and use by My Intellectual Space
            and its affiliates.
          </p>
        </div>
        ...
        <div id="content" class="mb-12">
          ...
          <p class="leading-loose mb-4">
            ...
            Agreement, or Community Guidelines, including for example, copyright
            or trademark violations or other intellectual property
            misappropriation, impersonation, unlawful conduct, or harassment.
            Information regarding specific policies and the process for
            reporting or appealing violations can be found in our Community
            Guidelines.
          </p>
        </div>
        ...
        <div id="rights" class="mb-12">
          ...
          <p class="leading-loose mb-4">
            ...
            for My Intellectual Space to provide, promote, and improve the
            ...
            our terms and conditions for such Content use. Such additional uses
            by My Intellectual Space, or other companies, organizations or
            ...
            available through the Services as the use of the Services by you is
            hereby agreed as being sufficient compensation for the Content and
            grant of rights herein.
          </p>
          <p class="leading-loose mb-4">
            My Intellectual Space has an evolving set of rules for how ecosystem
            partners can interact with your Content on the Services. These rules
            exist to enable an open ecosystem with your rights in mind. You
            understand that we may modify or adapt your Content as it is
            distributed, syndicated, published, or broadcast by us and our
          ...
          <p class="leading-loose mb-4">
            ...
            are otherwise legally entitled to post the material and to grant My
            Intellectual Space the license described above.
          </p>
        </div>
        ...
        <div id="using-services" class="mb-12">
          ...
          <p class="leading-loose mb-4">
            Please review the My Intellectual Space Community Guidelines, which
            are part of the Terms of Service and outline what is prohibited on
        ...
        <div id="your-license" class="mb-12">
          ...
          <p class="leading-loose mb-4">
            My Intellectual Space gives you a personal, worldwide, royalty-free,
            non-assignable and non-exclusive license to use the software
            provided to you as part of the Services. This license has the sole
            purpose of enabling you to use and enjoy the benefit of the Services
            as provided by My Intellectual Space, in the manner permitted by
            these Terms.
          </p>
          <p class="leading-loose mb-4">
            The Services are protected by copyright, trademark, and other laws
            of both the United States and other countries. Nothing in the Terms
            gives you a right to use the My Intellectual Space name or any of
            the My Intellectual Space trademarks, logos, domain names, other
            distinctive brand features, and other proprietary rights. All right,
            title, and interest in and to the Services (excluding Content
            provided by users) are and will remain the exclusive property of My
            Intellectual Space and its licensors. Any feedback, comments, or
            suggestions you may provide regarding My Intellectual Space, or the
        ...
        <div id="ending-terms" class="mb-12">
          ...
          <p class="leading-loose mb-4">
            You may end your legal agreement with My Intellectual Space at any
            time by deactivating your accounts and discontinuing your use of the
            Services.
          </p>
          <p class="leading-loose mb-4">
            ...
            have violated these Terms or the My Intellectual Space Community
            Guidelines, (ii) you create risk or possible legal exposure for us;
            (iii) your account should be removed due to unlawful conduct, (iv)
            your account should be removed due to prolonged inactivity; or (v)
            ...
            access your account, depending on the circumstances. In all such
            cases, the Terms shall terminate, including, without limitation,
            your license to use the Services, except that the following sections
            shall continue to apply: 2, 3, 5, and 6. If you believe your account
            was terminated in error you can file an appeal following the steps
            found in our Community Guidelines. For the avoidance of doubt, these
        ...
        <div id="disclaims" class="mb-12">
          ...
          <p class="leading-loose mb-4">
            ...
            you on an “AS IS” and “AS AVAILABLE” basis. The “My Intellectual
            Space Entities” refers to My Intellectual Space, its parents,
            ...
            THE MY INTELLECTUAL SPACE ENTITIES DISCLAIM ALL WARRANTIES AND
            CONDITIONS, WHETHER EXPRESS OR IMPLIED, OF MERCHANTABILITY, FITNESS
            FOR A PARTICULAR PURPOSE, OR NON-INFRINGEMENT. The My Intellectual
            Space Entities make no warranty or representation and disclaim all
            ...
            advice or information, whether oral or written, obtained from the My
            Intellectual Space Entities or through the Services, will create any
            warranty or representation not expressly made herein.
          </p>
          <p class="leading-loose mb-4">
            TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, THE MY
            INTELLECTUAL SPACE ENTITIES SHALL NOT BE LIABLE FOR ANY INDIRECT,
            ...
            ON THE SERVICES, INCLUDING WITHOUT LIMITATION, ANY DEFAMATORY,
            ...
            SHALL THE AGGREGATE LIABILITY OF THE MY INTELLECTUAL SPACE ENTITIES
            ENTITIES EXCEED THE GREATER OF ONE HUNDRED U.S. DOLLARS (U.S.
            $100.00) OR THE AMOUNT YOU PAID MY INTELLECTUAL SPACE ENTITIES, IF
            ANY, IN THE PAST SIX MONTHS FOR THE SERVICES GIVING RISE TO THE
            CLAIM. THE LIMITATIONS OF THIS SUBSECTION SHALL APPLY TO ANY THEORY
            OF LIABILITY, WHETHER BASED ON WARRANTY, CONTRACT, STATUTE, TORT
            (INCLUDING NEGLIGENCE) OR OTHERWISE, AND WHETHER OR NOT THE MY
            INTELLECTUAL SPACE ENTITIES HAVE BEEN INFORMED OF THE POSSIBILITY OF
            ANY SUCH DAMAGE, AND EVEN IF A REMEDY SET FORTH HEREIN IS FOUND TO
        ...
        <div id="general" class="mb-12">
          ...
          <p class="leading-loose mb-4">
            ...
            always be at this pace, will govern our relationship with you. We
          ...
          <p class="leading-loose mb-4">
            ...
            between you and My Intellectual Space. All disputes related to these
            Terms or the Services will be brought solely in the federal or state
            courts located in Fulton County, Georgia, United States, and you
          ...
          <p class="leading-loose mb-4">
            ...
            of the State of Georgia (excluding choice of law).
          </p>
          <p class="leading-loose mb-4">
            ...
            these Terms will remain in full force and effect. My Intellectual
            Space’s failure to enforce any right or provision of these Terms
